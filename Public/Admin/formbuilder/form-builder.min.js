...
!function (e) {
    var t = function (t, l) {
        ...
        var I = function () {
            ...
            e("<label/>").html(n.messages.description + " *").appendTo(i),  Q += '<div class="frm-fld name-wrap"><label>' + n.messages.name + ' <span class="required">*</span></label>', Q += '<input type="text" disabled="true" name="name" value="' + t.name + '" class="fld-name" id="title-' + p + '" /></div>', Q += '<div style="display: none" class="frm-fld access-wrap"><label>' + n.messages.roles + "</label>", Q += '<input type="checkbox" name="enable_roles" value="" ' + (void 0 !== t.role ? "checked" : "") + ' id="enable_roles-' + p + '"/> <label for="enable_roles-' + p + '" class="roles_label">' + n.messages.limitRole + "</label>", Q += '<div class="frm-fld available-roles" ' + (void 0 !== t.role ? 'style="display:block"' : "") + ">";
            ...
            switch (e.type) {
                ...
                case"radio-group":
                    ...
                    for (e.values.reverse(), t = e.values.length - 1; t >= 0; t--)l += '<div><label for="' + i + "-" + a + "-" + t + '">' + e.values[t].label + "</label></div>";
                    break;
                case"text":
                case"password":
                case"email":
            ...
            return "object" != typeof e ? e = {
                label: "",
                value: ""
            } : (e.label = e.label || "", e.value = e.value || ""), c = "<li>",  c += '<input type="text" class="option-label" placeholder="' + n.messages.optionLabelPlaceholder + '" value="' + e.label + '" />', c += '<input type="text" class="option-value hideinputbox" placeholder="' + n.messages.optionValuePlaceholder + '" value="' + e.value + '" />', c += '<a href="#" class="remove btn" title="' + n.messages.removeMessage + '">' + n.messages.remove + "</a>", c += "</li>"
        };
