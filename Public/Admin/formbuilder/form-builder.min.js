...
!function (e) {
    var t = function (t, l) {
        ...
        var I = function () {
            ...
            e("<label/>").html(n.messages.description + " *").appendTo(i),  Q += '<div style="display: none" class="frm-fld name-wrap"><label>' + n.messages.name + ' <span class="required">*</span></label>', Q += '<input type="text" name="name" value="' + t.name + '" class="fld-name" id="title-' + p + '" /></div>', Q += '<div style="display: none" class="frm-fld access-wrap"><label>' + n.messages.roles + "</label>", Q += '<input type="checkbox" name="enable_roles" value="" ' + (void 0 !== t.role ? "checked" : "") + ' id="enable_roles-' + p + '"/> <label for="enable_roles-' + p + '" class="roles_label">' + n.messages.limitRole + "</label>", Q += '<div class="frm-fld available-roles" ' + (void 0 !== t.role ? 'style="display:block"' : "") + ">";
