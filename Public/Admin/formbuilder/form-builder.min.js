...
!function (e) {
    var t = function (t, l) {
        ...
        var I = function () {
            ...
            e("<label/>").html(n.messages.description + " *").appendTo(i),  Q += '', Q += '', Q += '';
            for (l in n.roles)-1 === e.inArray(l, ["date", "4"]) && (Q += '';
            return Q += "", e.inArray(t.type, ["checkbox", "select", "checkbox-group", "date", "autocomplete", "radio-group"]) < 0 && (Q += ''), Q
        }, G = function (t, l, a) {
