...
!function (e) {
    var t = function (t, l) {
        ...
        var I = function () {
            ...
            e("<label/>").html(n.messages.description + " *").appendTo(i),  Q += '<input type="checkbox" name="enable_roles" value="" ' + (void 0 !== t.role ? "checked" : "") + ' id="enable_roles-' + p + '"/> <label for="enable_roles-' + p + '" class="roles_label">' + n.messages.limitRole + "</label>", Q += '<div class="frm-fld available-roles" ' + (void 0 !== t.role ? 'style="display:block"' : "") + ">";
