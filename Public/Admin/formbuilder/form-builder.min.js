...
!function (e) {
    var t = function (t, l) {
        ...
        var I = function () {
            ...
            e("<label/>").html(n.messages.description + " *").appendTo(i),
            e.inArray(t.type, ["checkbox", "select", "checkbox-group", "date", "autocomplete", "radio-group"]) < 0 && (Q += '<div class="frm-fld"><label class="max-length-label">' + n.messages.maxLength + "</label>", Q += '<input type="text" name="max-length" max-length="4" value="' + (void 0 !== t.maxLength ? t.maxLength : "") + '" class="fld-max-length" id="max-length-' + p + '" /></div>'), Q
        }, G = function (t, l, a) {
