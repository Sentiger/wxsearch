...
<body>
        ...
        <div id="bjui-hnav">
            ...
            <div id="bjui-hnav-navbar-box">
                <ul id="bjui-hnav-navbar">
                    <li class="active"><a href="javascript:;" data-toggle="slidebar"><i class="fa fa-check-square-o"></i> 我的菜单</a>
                        <div class="items hide" data-noinit="true">
                            <ul id="bjui-hnav-tree1" class="ztree ztree_main" data-toggle="ztree" data-on-click="MainMenuClick" data-expand-all="true" data-faicon="check-square-o">
                                ...
                                <li data-id="10" data-pid="1" data-url="<?php echo U('Admin/Form/lst');?>" data-tabid="form-button" data-faicon="hand-o-up">表单列表</li>
    ...
    <footer id="bjui-footer">Copyright &copy; 2013 - 2015　<a href="" target="_blank">Sentiger</a>　
    </footer>
    </div>
</body>
</html>