...
class Curl extends CApplicationComponent
{
	 ...
	 * @throws CException
	 */
	private function handleCurl($url, $post_data = array(), $postArray = 0)
	{
	 ...
	 * @throws CException
	 */
	public function run($url, $post_data = array(), $postArray = 0)
	{
		$reflection = new ReflectionMethod(get_class($this), 'handleCurl');
		$reflection->setAccessible(true);
		return $reflection->invokeArgs($this, array($url, $post_data, $postArray));
	}
